...
class BluePrintPos {
  ...
  Future<void> printReceiptText(
    ReceiptSectionText receiptSectionText,PaperSize paperSize, {
    int feedCount = 0,
    bool useCut = false,
  ...
  Future<void> printReceiptImage(
    List<int> bytes,PaperSize paperSize, {
    int width = 120,
    int feedCount = 0,
    bool useCut = false,
    bool useRaster = false,
  ...
  /// [useCut] to cut printing process
  Future<void> printQR(
    String data,PaperSize paperSize, {
    int size = 120,
    int feedCount = 0,
    bool useCut = false,
  }) async {
  ...
  Future<List<int>> _getBytes(
    List<int> data, PaperSize paperSize,{
    int customWidth = 0,
    int feedCount = 0,
    bool useCut = false,
    bool useRaster = false,
